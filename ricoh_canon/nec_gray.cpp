...
//
//    cam.OpenFirst();
//    cam.SetExposureTime(17228); //10000 us = 10 ms
//    //cam.SetExposureBurstCount(100);
...
//    cv::cvtColor(cv_mat_image, cv_mat_image, cv::COLOR_BGR2GRAY);
//    return cv_mat_image.clone();
